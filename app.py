...
from analise_falhas import RandomFail, resolver_vazao_estacionaria, avaliar_convergencia_monte_carlo, varredura_probabilidade_individual, aprox_dados, executar_monte_carlo_dinamico
...
def main():
    ...
    #======================== Monte Carlo - Problema 2 ========================
    executar_monte_carlo_dinamico(p_O=0.35, f_obs=5, N=2000, plot=True)
